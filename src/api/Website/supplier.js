...
export function delSupplierProduct(id) {
  return request({
    url: "/business/supplier/product/" + id,
    method: "delete",
  });
}
...
export function delSupplierAccount(id) {
  return request({
    url: "/business/supplier/account/" + id,
    method: "delete",
  });
}
...
export function delSupplierContact(id) {
  return request({
    url: "/business/supplier/contact/" + id,
    method: "delete",
  });
}
...
/**
 * 获取供应商收款账户信息
 * @param {Object} data - 包含supplierId的对象
 * @returns {Promise} 返回供应商收款账户信息数组
 */
export function getSupplierAccountInfo(data) {
  return request({
    url: "/business/supplier/accountInfo",
    method: "post",
    data: data,
  });
}